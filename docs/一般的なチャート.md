...
### 円グラフ
<video controls autoplay loop width="600" src='img/円グラフ.webm'></video>
...
### 一つの軸で複数メジャーを扱う
#### 方法1
<video controls autoplay loop width="600" src='img/一つの軸で複数メジャーを扱う1.webm'></video>
...
#### 方法2
<video controls autoplay loop width="600" src='img/一つの軸で複数メジャーを扱う2.webm'></video>
...
<video controls autoplay loop width="600" src='img/スパークライン.webm'></video>
...
### ガントチャート
<video controls autoplay loop width="600" src='img/ガントチャート.webm'></video>
...
### ドーナツチャート
<video controls autoplay loop width="600" src='img/ドーナツチャート.webm'></video>
...
### 並列棒グラフ
<video controls autoplay loop width="600" src='img/並列棒グラフ.webm'></video>
...
<video controls autoplay loop width="600" src='img/ブレットグラフ.webm'></video>
...
<video controls autoplay loop width="600" src='img/ブレットグラフ_表示形式を使わない方法.webm'></video>
...
<video controls autoplay loop width="600" src='img/Bar in Barhグラフ.webm'></video>
...
<video controls autoplay loop width="600" src='img/移動平均.webm'></video>
...
<video controls autoplay loop width="600" src='img/前年比成長率と前年比.webm'></video>
...
<video controls autoplay loop width="600" src='img/バンプチャート.webm'></video>
...
<video controls autoplay loop width="600" src='img/二重軸マップ.webm'></video>
...
<video controls autoplay loop width="600" src='img/集計表.webm'></video>

### ハイライト表
🌟ポイント
- 「メジャーバリュー」を[色]にドロップした場合、[別の凡例を使用]でメジャーごとに凡例の書式設定ができる。

<video controls autoplay loop width="600" src='img/ハイライト表.webm'></video>
